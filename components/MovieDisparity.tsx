...
const MovieDisparity: React.FC = () => {
  ...
  const [movieData, setMovieData] = useState<{ title: string; gap: number }[]>([]);
      ...
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">All of our episodes, ranked by the critic/audience disparity.</p>
          </div>
        </div>
      </CardHeader>
      <CardContent>
